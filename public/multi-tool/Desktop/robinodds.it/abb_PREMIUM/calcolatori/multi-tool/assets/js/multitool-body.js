...
var less_2 = $(".grid_row_5").add($("#riga_tabRisult_M5")).add($(".grid_rigaAgg_5")).add($(".grid_Risult_M5")).add($(".grid_row_4")).add($("#riga_tabRisult_M4")).add($(".grid_rigaAgg_4")).add($(".grid_Risult_M4")).add($(".badgeOnGo.statusSet[myindex=4]")).add($(".badgeOnGo.statusSet[myindex=3]"));
var less_1 = $(".grid_row_5").add($("#riga_tabRisult_M5")).add($(".grid_rigaAgg_5")).add($(".grid_Risult_M5")).add($(".badgeOnGo.statusSet[myindex=4]"));
...
function CP_teorica(M_num) {
  ...
  if ($(endCP_elm).val()) {
    ...
    var contOfTheCPBox = 'copertura completa con: 👉 <span class="" id="info_CP1_' + M_num + '">' +
      endCP.toFixed(2) + "€" +
      '</span> 👈';
  ...
  if ($(endDCH1_elm).val()) {
    var contOfTheDCH1Box = 'copertura completa con: 👉 <span class="" id="info_DCH1_' + M_num + '">' +
      endDCH1.toFixed(2) + "€" +
      '</span> 👈';
  ...
  if ($(endDCH2_elm).val()) {
    var contOfTheDCH2Box = 'copertura completa con: 👉 <span class="" id="info_DCH2_' + M_num + '">' +
      endDCH2.toFixed(2) + "€" +
      '</span> 👈';
...
function resetAll() {
  ...
  if ($("#boxGridRisultatiIniziali").css('display') == "grid") $("#DivIntestazioneGrid").click();
